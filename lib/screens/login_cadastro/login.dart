            ...
            children: [
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                        ...
                        suffixIcon: IconButton(
                            ...
                            icon: Icon(iconSenha)),
                        suffixIconColor:
                            const Color.fromARGB(255, 20, 57, 190)),
                  ),
                ],
              ),
              ...
              ElevatedButton(
                ...
                onPressed: () async {
                  String? error = await Auth().entrar(
                      Autenticacao(email: email.text, password: password.text));
              ...
              Row(
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () {
                      Navigator.pushNamed(context, MyRoutes.cadastro);
                    },
                    child: const Text(
                      "Cadastrar",
                      style:
                          TextStyle(color: Color.fromARGB(255, 35, 105, 242)),
                    ),
                  ),
                ],
              )
